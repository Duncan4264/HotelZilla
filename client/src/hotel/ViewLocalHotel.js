...
const ViewLocalHotel = ({ match, history }) => {
  ...
  const loadSellerHotel = async () => {
    try {
      ...
      setName(res.data.data.body.propertyDescription.name);
      let imageUrl =
        res.data.data.body.roomsAndRates.rooms[0].images[0].fullSizeUrl;
            ...
            <div className="row">
              ...
              <div className="col-md-6">
                ...
                <p className="alert alert-info mt-3">
                  {hotel.ratePlans[0].price.current}
                </p>
                ...
                <p>
                  Address: {hotelInfo.propertyDescription.address.fullAddress}
                </p>
                <p>
                  Reviews: {hotelInfo.guestReviews.brands.rating} out of{' '}
                  {hotelInfo.guestReviews.brands.scale}
                </p>
