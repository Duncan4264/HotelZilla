    ...
    <div className="row">
      ...
      <div className="col-sm-6 col-md-4 footer-contacts">
        <div>
          ...
          <p>
            <span className="new-line-span">3300 W Calemback Road</span>Phoenix
            Arizona
          </p>
        </div>
        <div>
      ...
      <div className="col-md-4 footer-about">
        ...
        <div className="social-links social-icons">
          <a href="https://www.linkedin.com/in/cyrus-duncan-35a209198/">
            <i className="fa fa-linkedin"></i>
          </a>
          <a href="https://github.com/Duncan4264">
