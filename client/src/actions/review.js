...
export const create = async (token, data) => {
  try {
    ...
    let review = await axios.post(
      `${process.env.REACT_APP_API}/create-review`,
      data,
      {
        headers: {
          // with jwt token
...
export const readReviews = async (hotelId, token) => {
  try {
    ...
    let reviews = await axios.get(
      `${process.env.REACT_APP_API}/reviews/${hotelId}`,
      {
        headers: {
          Authorization: `Bearer ${token}`
        }
...
export const countReviews = async (userId, token) => {
  try {
    ...
    let count = await axios.get(
      `${process.env.REACT_APP_API}/user/reviewcount/${userId}`,
      {
        headers: {
          Authorization: `Bearer ${token}`
        }
...
export const readuserReviews = async (userId, token) => {
  try {
    // grab user reviews
    let reviews = await axios.get(
      `${process.env.REACT_APP_API}/users/reviews/${userId}`,
      {
...
export const edit = async (reviewId, data, token) => {
  try {
    ...
    let review = await axios.put(
      `${process.env.REACT_APP_API}/edit-review/${reviewId}`,
      data,
      {
        headers: {
          // with jwt token
...
export const readLocalReview = async (hotelId, token) => {
  try {
    // get reviews from api
    let reviews = await axios.get(
      `${process.env.REACT_APP_API}/local/reviews/${hotelId}`,
      {
        headers: {
          Authorization: `Bearer ${token}`
        }
