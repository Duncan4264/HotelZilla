...
export const sellerHotels = async (token, userId) => {
  try {
    ...
    let sellerHotels = await axios.get(
      `${process.env.REACT_APP_API}/seller-hotels/${userId}`,
      {
        headers: {
          Authorization: `Bearer ${token}`
        }
...
export const profileHotels = async (userId, token) => {
  try {
    let ProfileHotels = await axios.get(
      `${process.env.REACT_APP_API}/profile-hotels/${userId}`,
      {
        headers: {
          Authorization: `Bearer ${token}`
        }
...
export const deleteHotel = async (token, hotelId) => {
  try {
    ...
    let deleteHotel = await axios.delete(
...
export const updateHotel = async (token, data, hotelId) => {
  try {
    ...
    let updateHotel = await axios.put(
...
export const userHotelBookings = async (token, userId) =>
  await axios.get(
    `${process.env.REACT_APP_API}/user-hotel-bookings/${userId}`,
    {
      headers: {
        Authorization: `Bearer ${token}`
      }
...
export const countHotels = async (userId, token) => {
  try {
    ...
    let count = await axios.get(
      `${process.env.REACT_APP_API}/user/hotels/${userId}`,
      {
        headers: {
          Authorization: `Bearer ${token}`
        }
...
export const readAllLocalHotels = async () => {
  try {
    let hotels = await axios.get(
      `${process.env.REACT_APP_API}/local/hotels/Phoenix`
    );
    return hotels.data;
  } catch (error) {
    console.log(error);
...
export const readLocalHotel = async (token, hotelId) => {
  try {
    let hotel = await axios.get(
      `${process.env.REACT_APP_API}/local/hotel/${hotelId}`,
      {
        headers: {
          Authorization: `Bearer ${token}`
        }
...
export const listLocalHotels = async (query, token) => {
  try {
    // await response from backend when making a post request to search listings uri with query parameter
    let lists = await axios.post(
      `${process.env.REACT_APP_API}/search-local-listings`,
      query,
      {
        headers: {
          Authorization: `Bearer ${token}`
