...
export const createConnectionAccount = async (token, userId) => {
  try {
    ...
    let connection = await axios.post(
      `${process.env.REACT_APP_API}/createStripeAccount/${userId}`,
      {},
      {
        headers: {
...
export const getStripeStatus = async (token, userId) => {
  try {
    ...
    let status = await axios.post(
      `${process.env.REACT_APP_API}/getAccountStatus/${userId}`,
      {},
      {
        headers: {
          Authorization: `Bearer ${token}`
...
export const getAccountBalance = async (token, userId) => {
  try {
    ...
    let balance = await axios.post(
      `${process.env.REACT_APP_API}/getAccountBalance/${userId}`,
      {},
      {
        headers: {
          Authorization: `Bearer ${token}`
...
export const getPayoutSettings = async (token, userId) => {
  try {
    ...
    let payout = await axios.post(
      `${process.env.REACT_APP_API}/PayoutSettings/${userId}`,
      {},
      {
        headers: {
          Authorization: `Bearer ${token}`
