...
export const read = async (userId) => {
  try {
    ...
    let profile = await axios.get(
      `${process.env.REACT_APP_API}/profile/${userId}`
    );
    // return the profile
    return profile;
  } catch (error) {
...
export const create = async (token, data, profileId) => {
  try {
    ...
    let profile = await axios.post(
      `${process.env.REACT_APP_API}/create-profile/${profileId}`,
      data,
      {
        headers: {
...
export const editProfile = async (token, data, profileId) => {
  try {
    ...
    let profile = await axios.put(
      `${process.env.REACT_APP_API}/update-profile/${profileId}`,
      data,
      {
...
export const deleteProfile = async (token, profileId) => {
  try {
    ...
    let response = await axios.delete(
      `${process.env.REACT_APP_API}/delete-profile/${profileId}`,
      {
        headers: {
          Authorization: `Bearer ${token}`
        }
